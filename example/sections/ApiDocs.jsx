...
const API_SECTIONS = [
  ...
  },
  {
    ...
    title: "Droppable",
    badge: "Component",
    desc: "Defines a drop zone. Calls onDrop when an item is released over it. Supports render props for access to isOver state.",
    props: [
      { prop: "id", type: "string", desc: "Unique ID for this drop zone." },
      { prop: "onDrop", type: "(item) => void", desc: "Called when an item is dropped. item = { id, type, data }." },
      {
        prop: "children",
        type: "node | (isOver, ref) => node",
        desc: "Static children, or a render function receiving isOver (boolean) and ref (attach to your drop element).",
      },
      { prop: "className", type: "string?", desc: "CSS classes for the wrapper div (only when children is static, not a render function)." },
    ],
    note: "item object: { id: string, type: string, data: any }",
  },
  {
  ...
  },
  {
    ...
    props: [
      ...
      { prop: "children", type: "node | (renderProps) => node", desc: "Static children get automatic grab cursor + opacity. Render function receives { ref, isOver, isActive, onMouseDown }." },
  ...
  },
  {
    ...
    props: [
      ...
      {
        prop: "children",
        type: "node | ({ isOver }) => node",
        desc: "Render function receives isOver. Use it to style the drop zone on hover.",
      },
...
const HOOKS = [
  ...
  },
  {
    ...
    signature: "useDrop({ id, onDrop })",
    returns: "{ dropRef, isOver }",
